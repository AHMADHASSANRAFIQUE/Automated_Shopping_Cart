...
# Load Vertex AI credentials safely
...
def run_instacart_agent(vendor_url: str = 'https://www.instacart.com'):
    web_task = Task(
        description=f"Open a browser and navigate to '{vendor_url}'",
    ...
    print(f"\nWeb Agent's Response for {vendor_url}:")
